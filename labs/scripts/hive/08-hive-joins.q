...
# Load Data
LOAD DATA LOCAL INPATH '/home/ubuntu/futurense_hadoop-pyspark/labs/dataset/empmgmt/employee1.txt' OVERWRITE INTO TABLE employee1;
...
# Load Data
LOAD DATA LOCAL INPATH '/home/ubuntu/futurense_hadoop-pyspark/labs/dataset/empmgmt/country.txt' OVERWRITE INTO TABLE country;
